    ...
    async changeFavourite(file) {
        ...
        .then(response => {
            if (response.status !== 200) {
                alert("failed adding to favourite" + response.status)
            }
            else {
        ...
        return (    
            <div className = 'file-view'>
                ...
                <div className = 'icons-view'>
                    <img src = {floderLogo} className = 'file-icon' alt = {floderLogo2}  onClick = { () =>
                        this.props.updatePath(this.props.file.fileId, this.props.file.fileName),
                        this.props.fetchFolderData
                    } /> 
                ...
                <div className = 'file-view-menu'>
                    ...
                    {this.state.menuVisibility ? <MenuView file = {this.props.file} fetchFolderData = {() => this.props.fetchFolderData}  refreshData = {this.props.refreshData} menuVisibility = {this.showMenu}/> : null}
                </div>
